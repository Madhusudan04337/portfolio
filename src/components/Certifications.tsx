        ...
        {certificationsData.length > 3 && (
          <div className="mt-16 text-center">
            <motion.button
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-white border border-zinc-200 rounded-full text-zinc-800 font-bold hover:bg-zinc-50 hover:border-zinc-300 transition-all shadow-sm active:scale-95"
            >
              {showAll ? (

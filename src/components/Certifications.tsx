...
export function Certifications() {
  ...
  return (
    <section id="certifications" className="py-16 px-6 bg-[#FAFAFA]">
      <div className="max-w-[1100px] mx-auto">
        <div className="mb-12 text-center">
           <h2 className="text-3xl md:text-4xl font-display font-bold mb-3 text-zinc-800 tracking-tight">
            ...
            {visibleCertifications.map((cert) => (
              ...
              >
                <div className="flex justify-between items-start mb-4 gap-4">
                   <h3 className="text-[16px] font-bold text-zinc-800 leading-snug max-w-[200px]">
                     {cert.title}
                   </h3>
        ...
        {certificationsData.length > 3 && (
          <div className="mt-16 text-center">
            <motion.button
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-white border border-zinc-200 rounded-full text-zinc-800 text-sm font-bold hover:bg-zinc-50 hover:border-zinc-300 transition-all shadow-sm active:scale-95"
            >
              {showAll ? (

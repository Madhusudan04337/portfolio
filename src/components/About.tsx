...
export function About() {
  return (
    <section id="about" className="py-10 md:py-16 px-6 relative overflow-hidden">
        ...
        >
          ...
          <div className="pt-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex flex-col gap-2 p-3.5 rounded-xl border border-zinc-200 bg-white/50">
              ...
              <h4 className="font-medium text-sm text-zinc-900">Current Focus</h4>
              <p className="text-[13px] text-zinc-500">{aboutData.context.focus}</p>
            </div>
            <div className="flex flex-col gap-2 p-3.5 rounded-xl border border-zinc-200 bg-white/50">
              <Database className="w-5 h-5 text-[#A8C69F] mb-1" />
              <h4 className="font-medium text-sm text-zinc-900">Core Expertise</h4>
              <p className="text-[13px] text-zinc-500">{aboutData.context.background}</p>
            </div>
            <div className="flex flex-col gap-2 p-3.5 rounded-xl border border-zinc-200 bg-white/50 sm:col-span-2">
              ...
              <h4 className="font-medium text-sm text-zinc-900">Recent Milestone</h4>
              <p className="text-[13px] text-zinc-500">{aboutData.context.milestone}</p>
            </div>
          </div>
          ...
          <div>
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#4A32A1]/30 text-[#4A32A1] hover:bg-[#4A32A1]/10 hover:border-[#4A32A1]/50 transition-all group text-sm font-medium"
            >
              {aboutData.cta.text}
